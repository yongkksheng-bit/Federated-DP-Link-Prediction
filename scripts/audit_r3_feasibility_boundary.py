"""Replay and audit the frozen R3 analytical boundary grid."""
...
from run_r3_feasibility_boundary import RESULTS, execute
...
def main() -> None:
    ...
    audit = {
        "schema_version": 1,
        "protocol": "R3_CERTFED_LP_FEASIBILITY_BOUNDARY_v1_AUDIT",
        "status": "PASS"
