...
BlogCatalog uses Syracuse Data Lab v3 \cite{zafarani2026datalab}; Facebook and
the attributed social-network family follow MUSAE
\cite{rozemberczki2021musae}. The artifact records exact sources, immutable
identifiers, canonicalization, and parser audits.
