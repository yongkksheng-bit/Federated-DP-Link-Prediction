...
| Pei et al., [LGA-PGNN](https://doi.org/10.1109/TIFS.2023.3329971), IEEE TIFS 2024 | Node classification from decentralized local graphs; cloud releases class-probability predictions | Formal epsilon-LDP mechanism perturbs selected node-feature dimensions; graph augmentation recovers utility; attribute-inference and link-stealing attacks are evaluated | No add/remove-edge theorem, transcript accountant, or LP scorer; a feature-LDP and attack-evaluation predecessor rather than an edge-DP LP baseline |
