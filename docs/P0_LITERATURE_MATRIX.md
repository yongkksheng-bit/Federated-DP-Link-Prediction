...
| PrivFGL, [Differentially Private Federated Graph Learning via Personalized Data Transformation](https://doi.org/10.1109/TRUSTCOM66490.2025.00307), TrustCom 2025 | Mitigates DP-induced client heterogeneity in FGL | LP task, adjacency unit, and release-time output require full-paper verification before baseline admission |
